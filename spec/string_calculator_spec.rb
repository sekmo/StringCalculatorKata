...
describe StringCalculator do
  ...
  describe "small_numbers_from" do
    it "returns only numbers less than or equal to 1000" do
      expect(StringCalculator.small_numbers_from([1, 1000, 1001, 2000])).to eq([1, 1000])
    end
  end
end
